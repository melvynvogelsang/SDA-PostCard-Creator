...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        utilisateurs.get(211354).getConversation().addMessage("Message ajouté par le programme.",dateAAjouter,utilisateurAAjouter);
        ...
        data.loadMessagesSingleUser((Utilisateur) utilisateurs.get(12345),bot);
