...
public class TestLinkedList {
    ...
    public void run(){
        ...
        LoaderLinkedList loaderLinkedList = new LoaderLinkedList();

        // Temps de chargement des users
        long startTimeUsers = System.currentTimeMillis();
        loaderLinkedList.loadUsers(utilisateurs);
        ...
        loaderLinkedList.loadMessages(utilisateurs,bot);
        ...
        loaderLinkedList.loadMessagesSingleUser((Utilisateur) utilisateurs.get(12345),bot);
